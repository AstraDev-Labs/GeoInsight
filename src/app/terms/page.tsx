...
export const metadata: Metadata = {
    title: 'Terms of Service | GeoForesight',
    description: 'Terms of Service for the GeoForesight Research Platform. Guidelines for research contribution, intellectual property, and data privacy.',
    alternates: {
        canonical: '/terms',
    },
};
            ...
            <section className="flex-1 max-w-4xl mx-auto px-6 py-20 w-full">
                ...
                <div className="space-y-12 prose prose-slate max-w-none">
                    <section>
                        ...
                        <p className="text-slate-600 leading-relaxed">
                            By accessing or using the GeoForesight Research Platform (&quot;the Platform&quot;), you agree to be bound by these Terms of Service. If you do not agree to all of these terms, you are prohibited from using the Platform. These terms govern the contribution of data, peer-review processes, and the consumption of Earth observation intelligence provided by GeoForesight.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="text-slate-600 leading-relaxed">
                            Unless otherwise stated, all research published on GeoForesight is provided under an Open Access framework. However, the Platform retains the right to host and distribute the content. Authors maintain the right to their original findings but grant GeoForesight a perpetual, royalty-free license to display and archive the submission globally.
                        </p>
                    </section>
                ...
                <div className="mt-20 p-8 border border-slate-200 bg-slate-50 rounded-2xl">
                    <p className="text-center text-slate-500 text-sm italic">
                        Questions regarding these terms should be directed to the GeoForesight Board via the Support Center.
                    </p>
                </div>
            </section>
