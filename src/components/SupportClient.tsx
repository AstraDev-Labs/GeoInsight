            ...
            <div className="pt-36 pb-16 px-6 md:px-12 max-w-5xl mx-auto relative z-10 flex-1 w-full">
                ...
                >
                    ...
                    <p className="text-[#555] text-lg max-w-2xl mx-auto">
                        Need help with your submission, account, or have a question? We&apos;re here to assist you with any geospatial intelligence research queries.
                    </p>
                </motion.div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
                    ...
                    >
                        ...
                        <p className="text-[#555] text-sm mb-4">Learn how to submit research, manage posts, and use the Earth observation platform.</p>
                    ...
                    >
                        ...
                        <p className="text-[#555] text-sm mb-4">Reach out directly to our support team for urgent research issues or detailed GIS inquiries.</p>
                    ...
                    >
                        ...
                        <p className="text-[#555] text-sm mb-4">Find quick answers to the most commonly asked questions about satellite analysis.</p>
                ...
                >
                    ...
                    <p className="text-[#555] text-sm mb-8">Fill out the support form below and we&apos;ll get back to you regarding your Earth observation query within 24-48 hours.</p>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea
                                    ...
                                    placeholder="Describe your issue or geospatial research question..."
                                />
                            </div>
