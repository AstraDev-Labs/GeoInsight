            ...
            <div className="max-w-[1200px] mx-auto px-6 md:px-12 flex flex-col md:flex-row justify-between items-start gap-12 mb-16">
                ...
                <div className="flex gap-16 md:gap-24">
                    <div className="flex flex-col gap-4">
                        ...
                        <Link href="/" className="text-white/50 hover:text-white transition-colors text-sm font-medium">Home</Link>
                        <Link href="/categories" className="text-white/50 hover:text-white transition-colors text-sm font-medium flex items-center gap-2">Categories <span className="bg-primary/20 text-primary text-[10px] px-1.5 py-0.5 rounded uppercase tracking-wider font-bold">New</span></Link>
                        <Link href="/request-post" className="text-white/50 hover:text-white transition-colors text-sm font-medium">Submit Report</Link>
                        <Link href="/admin" className="text-white/50 hover:text-white transition-colors text-sm font-medium">Admin Portal</Link>
                    </div>

                    <div className="flex flex-col gap-4">
                        <span className="text-white font-bold uppercase tracking-widest text-xs mb-2">Legal</span>
                        <Link href="/privacy" className="text-white/50 hover:text-white transition-colors text-sm font-medium">Privacy Policy</Link>
                        <Link href="/terms" className="text-white/50 hover:text-white transition-colors text-sm font-medium">Terms of Service</Link>
                        <Link href="/support" className="text-white/50 hover:text-white transition-colors text-sm font-medium">Support</Link>
                    </div>
                </div>
            </div>
